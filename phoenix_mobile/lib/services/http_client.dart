...
class HttpClient {
      ...
      for (var attempt = 0; attempt < maxRetries; attempt++) {
        try {
          ...
          if (statusCode == 200 || statusCode == 409) {
            ...
            if (msg.contains('CRC') || msg.contains('checksum') || msg.contains('checksum')) {
  ...
  Future<String> downloadFile(
    ...
    FileLogger.log('[HttpClient.download] $name existingSize=$existingSize');
...
const _crc32Table = <int>[
  ...
  0x35B5A8FA, 0x42B2986C, 0xDBBBBD6E, 0x2BCB6DEB,
  ...
  0xA9BCAE52, 0xDEBB9EC5, 0x47D9827E, 0x30D5B5E8,
